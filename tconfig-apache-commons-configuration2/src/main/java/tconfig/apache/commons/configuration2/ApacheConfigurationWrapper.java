package tconfig.apache.commons.configuration2;
...
public class ApacheConfigurationWrapper implements Configuration {
    ...
    private org.apache.commons.configuration2.Configuration delegate;

    public ApacheConfigurationWrapper(org.apache.commons.configuration2.Configuration configuration) {
    ...
    public <T> List<T> getList(Class<T> cls, String key) {
        return delegate.getList(cls, key);
    }

    @Override
    public <T> List<T> getList(Class<T> cls, String key, List<T> defaultValue) {
        return delegate.getList(cls, key, defaultValue);
    }
}
